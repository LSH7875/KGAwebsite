...
-- 테이블 데이터 kga.cur_review:~2 rows (대략적) 내보내기
/*!40000 ALTER TABLE `cur_review` DISABLE KEYS */;
INSERT INTO `cur_review` (`id`, `curr_id`, `review_id`) VALUES
	(1, 1, 2),
	(2, 1, 11);
/*!40000 ALTER TABLE `cur_review` ENABLE KEYS */;
...
-- 테이블 데이터 kga.faq_curriculum:~18 rows (대략적) 내보내기
/*!40000 ALTER TABLE `faq_curriculum` DISABLE KEYS */;
INSERT INTO `faq_curriculum` (`cur_id`, `faq_id`) VALUES
	(1, 4),
	(1, 2),
	(1, 3),
	(2, 1),
