...
// ========================네비바===============================
// let navBar = document.querySelectorAll("nav_bar>a");

// navBar.addEventListener("mouseover",showSubNavi);
// function showSubNavi(){
//     const subNavi = document.querySelectorAll("nav_sub_list");
//     subNavi.
// }

// ==================코드 좀 더 다듬어 볼게요==========================

let classBtn = document.querySelectorAll(".class");
console.log(classBtn);
// classBtn.addEventListener("click",clickBtn);
